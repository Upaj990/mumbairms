...
import { AddNewOrder,OrderDetails, OrdersList, Profile,AddUser,Error } from '../..';
        ...
        <Toolbar sx={{display:'flex',flexDirection:'row',alignItems:'center',alignContent:'space-between',}}>
          ...
          {/* <IconButton 
            ...
            <Box sx={{display:'flex',flexDirection:'column',alignItems:'end',marginLeft:2,marginRight:1}}>
              ...
              <Typography variant="h6" style={{fontSize:14,color:_.colors.colorSubTitle,}} component="div">Chef</Typography>
            </Box>
            <IconButton
